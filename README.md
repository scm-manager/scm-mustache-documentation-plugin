...
Mustache models and documentations

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-mustache-documentation-plugin/docs/).
